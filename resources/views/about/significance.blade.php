        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                ...
                <div class="full-pic text-center">
                    <figure>
                        <img src="{{ asset('public/assets/images/str-imgs/str-6.jpg') }}" alt="">
                    </figure>
                </div>
                ...
                <div class="text-box mt-40">
                    <div class="text-content text-justify">
                        ...
                        <ul>
                            <li class="mb-3">{{ trans('about.significance-p3-l1') }}</li>
                            <li class="mb-3">{{ trans('about.significance-p3-l2') }}</li>
                            <li class="mb-3">{{ trans('about.significance-p3-l3') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
