                        ...
                        <div class="col-md-12 blog-post-hr">
                            <div class="blog-post mb-30">
                                    ...
                                    <div class="post-header">
                                        <h2><a href="{{ route('str.event-details', $event->slug) }}">{!! Str::limit($event->title, 40, '...') !!}</a></h2>
                                    </div>
                                    ...
                                    <div class="post-more-link pull-left">
                                        <a href="{{ route('str.event-details', $event->slug) }}" class="btn-text">Read More</a>
                                    </div>
                            </div>
                            <hr />
                        </div>
                    ...
                    @if ($events->lastPage() > 1)
                        <ul>
                            @if ($events->onFirstPage())
                                <li><a class="{{ ($events->currentPage() == 1) ? 'disabled' : '' }}"><i class="fa fa-angle-left"></i></a></li>
                            @else
                            ...
                            @if ($events->hasMorePages())
                                <li><a class="{{ ($events->currentPage() == $events->lastPage()) ? ' disabled' : '' }}" href="{{$events->nextPageUrl()}}"><i class="fa fa-angle-right"></i></a></li>
                            @else
