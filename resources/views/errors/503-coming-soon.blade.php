...
<body>
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="title">
                    <h1 class="text-white">
                        <span style="color: #f9c820; text-shadow: 2px 2px 4px #333;">Sanjay </span> <span style="color: #f4edd2; text-shadow: 2px 2px 4px #333;">Tiger Reserve</span>
                    </h1>
                </div>
    ...
    <script>
        function handleTickInit(tick) {
            ...
            Tick.count.schedule('monday at 12:00', { timezone: '+05:30' }).onupdate = function(value) {
                tick.value = value;
            }
        }
    </script>
