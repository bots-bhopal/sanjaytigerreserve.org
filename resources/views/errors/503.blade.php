...
<head>
    ...
    <title>STR | Service Unavailable</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/assets/images/str-logo.jpg')}}">
    <link rel="apple-touch-icon" type="image/x-icon" href="{{asset('public/assets/images/str-logo.jpg')}}">
