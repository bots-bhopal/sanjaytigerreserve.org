...
@section('title', 'STR - Registration System')
...
<div class="register-box">
    <div class="card card-outline card-primary">
        <div class="logo text-center">
            <img src="{{asset('public/assets/images/STR-org.png')}}" alt="STR-LOGO" width="80" height="110">
        </div>

        <div class="card-header text-center p-0">
            <a href="{{ url('/') }}" class="h1" target="_blank"><b>S</b>TR</a>
        </div>
